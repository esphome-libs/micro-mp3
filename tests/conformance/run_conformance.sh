...
#   l3-he_mode          -- mid-stream mono<->stereo transition, unsupported
...
EXCLUDE_RE='sideinfo|he_free|he_mode|vbrtag-oob-read'
...
echo "RESULT: all gated Layer III vectors >= ${MIN_PSNR} dB PSNR"
