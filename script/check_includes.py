...
CMAKE_SOURCE = os.path.join(ROOT, "host_examples", "mp3_to_wav")
CMAKE_ARGS = []
...
# tests/ is intentionally left unchecked: fuzz/ and conformance/ are
# self-contained CMake projects outside the main host_examples compile db
# (same situation as micro-flac's tests/fuzz and tests/regression).
...
# opencore-mp3dec is a third-party fork, not linted here (matches the
# cppcheck.sh / clang-tidy.sh exclusions).
EXCLUDE_DIRS = ["src/opencore-mp3dec"]
